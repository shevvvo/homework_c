...
TEST(INPUT_TEST, file2) { EXPECT_EQ(init_file_size("1.txt"), 52); }

TEST(INPUT_TEST, file3) { EXPECT_EQ(init_file_size("2.txt"), 52); }

TEST(INPUT_TEST, file4) { EXPECT_EQ(init_file_size("6.txt"), 106000000); }
